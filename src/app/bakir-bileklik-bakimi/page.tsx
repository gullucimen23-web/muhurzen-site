export const metadata = {
  ...
  description: "Bakır bileklik kararması ve temizliği için bakım önerileri.",
};
    ...
    <main className="min-h-screen bg-black px-5 py-12 text-white">
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 rounded-[2rem] border border-zinc-800 bg-zinc-950 p-6 md:p-10">
          ...
          <h1 className="mt-4 text-4xl font-black leading-tight md:text-5xl">Bakır Bileklik Bakımı</h1>
          <p className="mt-6 text-lg leading-8 text-zinc-300">Bakır bileklik kararması ve temizliği için bakım önerileri.</p>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Bakır Neden Kararır?</h2>
            <p className="mt-4 leading-8 text-zinc-300">Bakır hava, nem ve ciltle temas ettiğinde doğal olarak oksitlenebilir.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Temizlik Önerisi</h2>
            <p className="mt-4 leading-8 text-zinc-300">Yumuşak ve kuru bir bezle silmek günlük bakım için yeterlidir.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Saklama Önerisi</h2>
            <p className="mt-4 leading-8 text-zinc-300">Kullanılmadığında kuru bir yerde ve ayrı bir kutuda saklanması önerilir.</p>
          </section>
