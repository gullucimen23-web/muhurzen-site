export const metadata = {
  ...
  description: "Bakır Süleyman Mührü bileklik tasarımları ve bakım önerileri.",
};
    ...
    <main className="min-h-screen bg-black px-5 py-12 text-white">
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 rounded-[2rem] border border-zinc-800 bg-zinc-950 p-6 md:p-10">
          ...
          <h1 className="mt-4 text-4xl font-black leading-tight md:text-5xl">Bakır Süleyman Mührü Bileklik</h1>
          <p className="mt-6 text-lg leading-8 text-zinc-300">Bakır Süleyman Mührü bileklik tasarımları ve bakım önerileri.</p>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Bakırın Tasarımdaki Yeri</h2>
            <p className="mt-4 leading-8 text-zinc-300">Bakır rengi geleneksel sembollerle uyumlu, sıcak ve güçlü bir görünüm sunar.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Bakım Önerileri</h2>
            <p className="mt-4 leading-8 text-zinc-300">Nem ve kimyasal temastan uzak tutulması, yumuşak bezle temizlenmesi önerilir.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">MühürZen Kalitesi</h2>
            <p className="mt-4 leading-8 text-zinc-300">Her ürün kişisel kullanım ve hediye amacıyla özenle hazırlanır.</p>
          </section>
