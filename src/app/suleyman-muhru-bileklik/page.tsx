export const metadata = {
  ...
  description: "Süleyman Mührü bileklik modelleri ve kişiye özel tasarım süreci.",
};
    ...
    <main className="min-h-screen bg-black px-5 py-12 text-white">
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 rounded-[2rem] border border-zinc-800 bg-zinc-950 p-6 md:p-10">
          ...
          <h1 className="mt-4 text-4xl font-black leading-tight md:text-5xl">Süleyman Mührü Bileklik</h1>
          <p className="mt-6 text-lg leading-8 text-zinc-300">Süleyman Mührü bileklik modelleri ve kişiye özel tasarım süreci.</p>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Kimler İçin Uygun?</h2>
            <p className="mt-4 leading-8 text-zinc-300">Sembolik anlam taşıyan takıları sevenler için özel bir aksesuardır.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Kişiye Özel Hazırlık</h2>
            <p className="mt-4 leading-8 text-zinc-300">İsim, tarih veya özel notlarla tasarım kişiselleştirilebilir.</p>
          </section>

          <section className="mt-10">
            <h2 className="text-2xl font-black">Sipariş Süreci</h2>
            <p className="mt-4 leading-8 text-zinc-300">Form doldurularak sipariş oluşturulur ve hazırlık sürecine alınır.</p>
          </section>
